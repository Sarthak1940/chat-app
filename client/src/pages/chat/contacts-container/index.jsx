...
import { GET_CHANNELS_ROUTE, GET_CONTACTS_FOR_DM_ROUTE } from "@/utils/constants";
...
export const ContactsContainer = () => {
  ...
  return <div className="relative md:w-[35vw] lg:w-[30vw] xl:w-[20vw] bg-[#1b1c24] border-right-2 
  border-[#2f303b] w-full">
    ...
    <div className="my-5">
      ...
      <div className="max-h-[30vw] overflow-y-auto scrollbar-hidden">
