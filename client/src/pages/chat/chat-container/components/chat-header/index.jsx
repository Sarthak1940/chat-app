...
const ChatHeader = () => {
  ...
  return <div className="h-[10vh] border-b-2 border-[#2f303b] flex items-center justify-center px-20">
        ...
        <div className="w-12 h-12 relative">
          {
            selectedChatType === "contact" ? (
              ...
              {selectedChatData.image ? 
                ...
                /> : 
                <div className={`uppercase h-12 w-12 text-lg border-[1px] flex items-center justify-center ${getcolor(selectedChatData.color)}`} style={{borderRadius: "50%"}}>
